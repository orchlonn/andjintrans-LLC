...
const recommendations = [
  {
    ...
    description: "Контейнертэй тээвэр боомтын терминалаар дамждаг тул FOB нь зарим тохиолдолд буруу хэрэглэгддэг; олон кейст FCA/CPT/CIP илүү тохиромжтой байдаг.",
  },
  {
    title: "DAP vs DPU",
