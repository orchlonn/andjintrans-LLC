...
const contactInfo = [
  {
    ...
    title: "Хаяг",
    content: "Монгол улс, Улаанбаатар хот, Сүхбаатар дүүрэг, 9-р хороо, 7-р хороолол /14182/, Алтайн гудамж, Хоймор оффис, 207 тоот",
    color: "cyan",
  },
  {
    icon: (
        ...
        <div className="mx-auto max-w-5xl">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {contactInfo.map((info, index) => {
                ...
                return (
                  ...
                  >
                    <div className={`mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br ${colors.icon}`}>
                      <span className="text-slate-900">{info.icon}</span>
                    </div>
                    <h3 className="text-lg font-semibold text-white">{info.title}</h3>
                    <p className="mt-2 text-slate-300">{info.content}</p>
                  </motion.div>
                );
              })}
            </div>
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] border border-cyan-500/20 bg-gradient-to-br from-slate-900/90 via-slate-900/70 to-slate-800/50 p-8 backdrop-blur-xl md:p-12">
              ...
              <div className="relative">
                ...
                <div className="mb-10 text-center">
                  ...
                  <h2 className="text-2xl font-bold text-white md:text-3xl">Мессеж илгээх</h2>
                  <p className="mt-3 text-slate-400">Доорх маягтыг бөглөж бидэнтэй холбогдоно уу</p>
                </div>
                ...
                <form className="space-y-6">
                  <div className="grid gap-6 md:grid-cols-2">
                    {/* Name Field */}
                    <div className="group">
                      <label htmlFor="name" className="mb-2 flex items-center gap-2 text-sm font-medium text-slate-300">
                    ...
                    {/* Company Field */}
                    <div className="group">
                      <label htmlFor="company" className="mb-2 flex items-center gap-2 text-sm font-medium text-slate-300">
                  ...
                  <div className="grid gap-6 md:grid-cols-2">
                    {/* Email Field */}
                    <div className="group">
                      <label htmlFor="email" className="mb-2 flex items-center gap-2 text-sm font-medium text-slate-300">
                    ...
                    {/* Phone Field */}
                    <div className="group">
                      <label htmlFor="phone" className="mb-2 flex items-center gap-2 text-sm font-medium text-slate-300">
                  ...
                  {/* Service Selection */}
                  <div className="group">
                    <label htmlFor="service" className="mb-2 flex items-center gap-2 text-sm font-medium text-slate-300">
                    ...
                    <div className="relative">
                      ...
                      >
                        <option value="" className="bg-slate-900">Сонгоно уу</option>
                        <option value="air" className="bg-slate-900">Агаарын тээвэр</option>
                        <option value="sea" className="bg-slate-900">Далайн тээвэр</option>
                        <option value="rail" className="bg-slate-900">Төмөр замын тээвэр</option>
                        <option value="road" className="bg-slate-900">Авто замын тээвэр</option>
                        <option value="transit" className="bg-slate-900">Транзит тээвэр</option>
                        <option value="insurance" className="bg-slate-900">Ачааны даатгал</option>
                        <option value="customs" className="bg-slate-900">Гаалийн бүрдүүлэлт</option>
                        <option value="domestic" className="bg-slate-900">Дотоодын хүргэлт</option>
                        <option value="other" className="bg-slate-900">Бусад</option>
                      </select>
                  ...
                  {/* Message Field */}
                  <div className="group">
                    <label htmlFor="message" className="mb-2 flex items-center gap-2 text-sm font-medium text-slate-300">
          ...
          >
            <div className="rounded-3xl border border-cyan-500/30 bg-gradient-to-br from-cyan-500/10 via-slate-900/50 to-blue-500/10 p-8 md:p-12">
              <h2 className="text-2xl font-bold text-white md:text-3xl">Ажлын цаг</h2>
              <div className="mt-6 grid gap-4 md:grid-cols-2">
                <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                  <p className="text-sm text-slate-400">Даваа – Баасан</p>
                  <p className="mt-1 text-lg font-semibold text-white">09:00 – 18:00</p>
                </div>
                <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                  <p className="text-sm text-slate-400">Бямба – Ням</p>
                  <p className="mt-1 text-lg font-semibold text-white">Амарна</p>
                </div>
              </div>
            </div>
          </motion.section>
