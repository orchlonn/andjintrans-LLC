...
export default function AirTransportPage() {
  const t = useTranslations("ServicesAir");
      ...
      <div className="px-6 pb-24">
        <div className="mx-auto max-w-5xl">
          ...
          <motion.section
            ...
            className="mb-16"
          >
            <h2 className="text-2xl font-bold text-slate-900 md:text-3xl">{tc("processAlt")}</h2>
          ...
          <motion.section
            ...
            className="mb-16"
          >
            <h2 className="text-2xl font-bold text-slate-900 md:text-3xl">{tc("principles")}</h2>
            <div className="mt-8 space-y-4">
