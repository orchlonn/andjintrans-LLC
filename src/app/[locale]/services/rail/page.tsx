...
export default function RailTransportPage() {
  const t = useTranslations("ServicesRail");
          ...
          >
            ...
            <div className="mt-8 space-y-4">
              {processSteps.map((item, index) => (
                ...
                >
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-sky-400 to-sky-600">
