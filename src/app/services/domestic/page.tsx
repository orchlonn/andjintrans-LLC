      ...
      <div className="px-6 pb-24">
        <div className="mx-auto max-w-5xl">
          ...
          <motion.section
            ...
            className="mb-16"
          >
            <h2 className="text-2xl font-bold text-slate-900 md:text-3xl">Бид ямар төрлийн хүргэлт хийдэг вэ?</h2>
          ...
          <motion.section
            ...
            className="mb-16"
          >
            <h2 className="text-2xl font-bold text-slate-900 md:text-3xl">Ямар үед энэ үйлчилгээ хамгийн хэрэгтэй вэ?</h2>
          ...
          <motion.section
            ...
            className="mb-16"
          >
            <h2 className="text-2xl font-bold text-slate-900 md:text-3xl">Хүргэлтэнд хэрэгтэй мэдээлэл (Quote авахад)</h2>
